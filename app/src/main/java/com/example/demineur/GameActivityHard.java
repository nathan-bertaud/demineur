...
import com.example.demineur.databinding.ActivityGameHardBinding;
...
public class GameActivityHard extends AppCompatActivity implements SquareFragmentInterface{

    private SquareFragment squareTab[][]=new SquareFragment[10][10];
    private int nrow=7;
    private int ncol=7;
    private int tableRow[]=new int[7];

    private ActivityGameHardBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGameHardBinding.inflate(getLayoutInflater());
        ...
        tableRow[4]=R.id.tableRow5;
        tableRow[5]=R.id.tableRow6;
        tableRow[6]=R.id.tableRow7;
        loadFragments();
    ...
    protected void loadFragments(){
        ...
        for(int nbBombs = 0; nbBombs < 10; nbBombs++){
    ...
    private int[] generateBombs(){
        int i = new Random().nextInt(nrow);
        int j = new Random().nextInt(ncol);
        return new int[]{i, j};
    }
