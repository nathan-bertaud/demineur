...
import com.example.demineur.databinding.ActivityGameMediumBinding;
...
public class GameActivityMedium extends AppCompatActivity implements SquareFragmentInterface{

    private SquareFragment squareTab[][]=new SquareFragment[10][10];
    private int nrow=5;
    private int ncol=5;
    private int tableRow[]=new int[5];

    private ActivityGameMediumBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGameMediumBinding.inflate(getLayoutInflater());
    ...
    protected void loadFragments(){
        ...
        for(int nbBombs = 0; nbBombs < 6; nbBombs++){
