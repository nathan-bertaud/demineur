...
import com.example.demineur.databinding.ActivityGameEasyBinding;
...
public class GameActivityEasy extends AppCompatActivity implements SquareFragmentInterface{
    ...
    private ActivityGameEasyBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGameEasyBinding.inflate(getLayoutInflater());
